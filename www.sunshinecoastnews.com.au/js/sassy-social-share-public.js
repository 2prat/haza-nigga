...
function heateorSssMoreSharingPopup(elem, postUrl, postTitle, twitterTitle) {
  ...
  for (var i in heateorSssMoreSharingServices) {
    ...
    heateorSssMoreSharingServicesHtml +=
      ...
      ';width:18px;height:18px;display:block;float:left;" title="' +
      heateorSssMoreSharingServices[i].title +
      '">' +
...
jQuery(function () {
  ...
  if (
    jQuery("div.heateor_sss_bottom_follow").length &&
    (typeof heateorSssMobileStickySharingEnabled == "undefined" ||
      heateorSssMobileStickySharingEnabled == 0 ||
      jQuery("div.heateor_sss_vertical_sharing").length == 0)
  ) {
    // insert div before </body>
    jQuery(document.body).append(
      "<div class='heateor_sss_mobile_footer'></div>"
